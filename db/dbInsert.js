...
const insertUsers = `INSERT INTO users (id, name, username, email, website, company)
...
const insertPosts = `INSERT INTO posts (id, title, body, userId) 
...
(1000, 'qui est esse', 'est rerum thees nequtiis voluptate porro vel nihil molestiae ut reiciendis\nqui aperiam non debitis possimus qui neque nisi nulla', 2999),
...
const insertComments = `INSERT INTO comments (id, name, email, body, postId) 
...
(2002,'test 3 comment 3 title rerum tempore vitae', 'test3@gmail.com', 'test body 3 sunt aut facere repellat provident occaecati sunt aut facere repellat provident occaecati', 1000),
(2003,'test 4 comment 4 title facere repellat', 'test4@gmail.com', 'test body 4 repellat provident repellat provident repellat provident', 1000),
(2004,'test 5 comment 5 title', 'test5@gmail.com', 'repellat provident occaecati', 1000),
(2005,'test 6 comment 6 title', 'test6@gmail.com', 'test body dolor beatae ea dolores', 1001);`;
...
Promise.each(queryArray, (itemQuery) => {
    return insertTable(itemQuery);
})
.then(() => console.log('All data were inserted!'));

function insertTable(itemQuery) {
